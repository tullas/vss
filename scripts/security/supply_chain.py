...
def validate_derivative_build_preparation(root: Path) -> None:
    expected = {
        "containers/versitygw/Dockerfile": "856daa6870da6cdd555481125622b854b2021a399474917e46c20a15d5013053",  # pragma: allowlist secret -- deterministic build-definition digest
        ...
        ".github/workflows/build-versitygw-derivative.yml": "9c862e8bcd9cd8caf8e529e34f5465984ea5be070306dfca80f1adbb5a9911f1",  # pragma: allowlist secret -- deterministic workflow digest
    }
