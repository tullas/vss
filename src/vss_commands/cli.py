...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.action == "movie":
        ...
        if args.movie_action in {"context-assemble-character-continuity", "analyze-character-continuity", "prepare-option-review", "record-option-review-decision"}:
            pass
