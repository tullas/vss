...
METADATA = CommandMetadata(name="platform.verify", version="1.0.0", description="Verify local platform and MinIO health.", input_schema={"type":"object","additionalProperties":False}, supports_dry_run=True)
@register(METADATA)
