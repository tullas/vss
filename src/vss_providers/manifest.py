...
from .constants import CLOCK_PROVIDER_TYPE, CONTROLLED_FRAME_PROVIDER_TYPE, CONTROLLED_VIDEO_PROVIDER_TYPE, PICTORIAL_FRAME_PROVIDER_TYPE, PROVIDER_API_VERSION, PROVIDER_MANIFEST_SCHEMA_VERSION, STORYBOARD_RENDER_PROVIDER_TYPE
...
def load_provider_manifest(path: Path, schema_path: Path, trusted_root: Path) -> RegisteredProvider:
    ...
    if value["provider_type"] not in {CLOCK_PROVIDER_TYPE, STORYBOARD_RENDER_PROVIDER_TYPE, PICTORIAL_FRAME_PROVIDER_TYPE, CONTROLLED_FRAME_PROVIDER_TYPE, CONTROLLED_VIDEO_PROVIDER_TYPE}:
