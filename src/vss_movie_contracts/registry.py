...
FILES = MappingProxyType({
    ...
    "record_scene_option_review_decision/1":"record-scene-option-review-decision-task-v1.schema.json",
    "scene_option_review_decision/1":"scene-option-review-decision-v1.schema.json",
    "create_scene_shot_plan_draft/1":"create-scene-shot-plan-draft-task-v1.schema.json",
    "scene_shot_plan_draft/1":"scene-shot-plan-draft-v1.schema.json",
    "scene_shot_plan_draft/2":"scene-shot-plan-draft-v2.schema.json",
    "create_scene_storyboard_specification/1":"create-scene-storyboard-specification-task-v1.schema.json",
    "scene_storyboard_specification/1":"scene-storyboard-specification-v1.schema.json",
    "scene_storyboard_specification/2":"scene-storyboard-specification-v2.schema.json",
...
COMPATIBILITY = MappingProxyType({
    ...
    "record_scene_option_review_decision/1": "scene_option_review_decision/1",
    "create_scene_shot_plan_draft/1": "scene_shot_plan_draft/1",
